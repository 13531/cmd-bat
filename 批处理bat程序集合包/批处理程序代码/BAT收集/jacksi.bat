...
if /I "%yslbxz%"=="jacksi" start iexplore http://www.cngr.cn
if /I "%yslbxz%"=="q" (exit)
goto 列表选择
...
if /I "%jinzhi%"=="jacksi" start iexplore http://www.cngr.cn
if /I "%jinzhi%"=="q" (EXIT)
goto 恢复专区
...
if /I "%jzcmd%"=="jacksi" start iexplore http://www.cngr.cn
...
if /i  "%whzq%"=="jacksi" start iexplore http://www.cngr.cn
